...
export class CatalogListComponent implements OnInit, OnDestroy {
    ...
    public carouselSlides: CarouselSlide[] = [
        // 1. Slide d'Accueil - Chemin uniformisé
        {
        ...
        // 2. Slide Métal - Chemin uniformisé
        {
            title: "Plaques d'Identification en Métal",
            subtitle: "Gravure Laser Industrielle",
            imageUrl: '../../../../assets/Logo/carousel2.jpg', 
            categoryName: 'Métaux',
            link: '/catalog?category=metal' 
        },
        // 3. Slide Plastique - Chemin uniformisé
        {
            title: "Signalétique Personnalisée",
            subtitle: "Idéal pour Bureau et Magasin",
            imageUrl: '../../../../assets/Logo/carrousel3.jpg',
            categoryName: 'Plastiques',
            link: '/catalog?category=plastique'
        },
        // 4. Slide Laiton - Chemin uniformisé
        {
            title: "Matériaux Premium: Laiton Brossé",
            subtitle: "Une élégance intemporelle pour vos façades",
            imageUrl: '../../../../assets/Logo/carousel 4.jpg', 
            categoryName: 'Laiton',
            link: '/catalog?category=laiton'
        }
    ];
    ...
    fetchCatalogData(): void {
        ...
        forkJoin({
            ...
            materials: this.catalogService.getMaterials()
        }).subscribe({
