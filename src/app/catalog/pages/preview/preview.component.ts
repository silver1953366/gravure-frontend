...
import { MaterialDimension } from '../../../core/models/material-dimension.model'; // Ajustez le chemin de votre modèle si nécessaire
...
export class PreviewComponent {
  /**
   * Reçoit l'objet MaterialDimension complet du parent (ConfiguratorComponent).
   */
