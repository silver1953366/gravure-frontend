...
export class AdminSidebarComponent {
  ...
  // isMini est un signal input : s'utilise avec isMini() dans le code
  ...
  readonly menus: AdminNavItem[] = [
    { label: 'Tableau de Bord', icon: 'fa-house', link: '/admin/dashboard' },
    { 
    ...
    { label: 'Inventaire', icon: 'fa-box', link: '/admin/inventory' },
    { 
    ...
    { label: 'Rapports & Stats', icon: 'fa-chart-bar', link: '/admin/reports' },
    { 
      label: 'Système', 
      icon: 'fa-gears', 
      children: [
   ...
   * Si la sidebar est en mode réduit (mini), on l'ouvre d'abord
   */
  ...
  /**
   * Vérifie si un sous-menu spécifique est ouvert
   */
