...
// NOTE : Ceci devrait être exporté depuis order.service ou un modèle,
// mais est conservé ici pour la complétude du fichier fourni.
...
    // Le template et le style sont également renommés
...
                        // Une bonne pratique serait de gérer un signal d'erreur ici.
                        return of(null);
                    })
                );
            }),
...
        }
        
        if (!confirm(`Confirmez-vous la conversion du devis n°${currentQuote.reference} en commande pour un total de ${currentQuote.final_price_fcfa | 0} FCFA ?`)) {
            return;
        }

        // Payload bidon, à remplacer par une logique de formulaire ou de sélection d'adresse réelle
...
                // Redirection vers la page de détails de la nouvelle commande
